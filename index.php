    ...
    <div class="container">
    	<form class="form-signin" method="post">
            ...
            <?php
				...
				if ($approved_forceshutdown)
				{
					echo "approved for shutdown";
					
					$approved_forceshutdown = false;
				}
				
                elseif ($approved_wake)
                {
				...
				elseif (isset($_POST['testbutton']) )
				{
					echo "<p style='color:#CC0000;'><b>Invalid Password. DENIED!</b></p>";
            ...
            ?>
				...
				<?php if ( (isset($_POST['submitbutton']) && $_POST['submitbutton'] == "Wake Up!") || (!isset($_POST['submitbutton']) && $asleep) ) {?>
						...
						<a href="http://<?php echo $COMPUTER_LOCAL_IP[$selectedComputer] . ":" . $COMPUTER_SLEEP_CMD_PORT . "/" .  "foceshutdown.php"?>" input class="btn btn-large btn-primary" type="submit" name="testbutton" value="Force Shutdown!" > Force Shutdown</a>
                    ...
                    <?php } else { ?>
						...
						<a href="http://<?php echo $COMPUTER_LOCAL_IP[$selectedComputer] . ":" . $COMPUTER_SLEEP_CMD_PORT . "/" .  "forceshutdown.php"?>" input class="btn btn-large btn-primary" type="submit" name="testbutton" value="Force Shutdown!" > Force Shutdown</a>
